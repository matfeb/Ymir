...
{
	private JFrame destinationFrame = null;
	...
	public ComponentMover(Component destinationComponent, Component... components)
	{
		...
		if (this.destinationComponent.getClass().getName().equals("fr.rexed.ted.gui.MainWindow"))
		{
			this.destinationFrame = (JFrame)destinationComponent;
		}
		registerComponent( components );
	}
	...
	{		
		...
		{
			destinationFrame.setExtendedState(JFrame.NORMAL);
		}
	...
	public void mouseClicked(MouseEvent e) 
	{
		...
		if (e.getClickCount() % 2 == 0 & !e.isConsumed())
		{
			...
			if (destinationFrame != null)
				...
				destinationFrame.setExtendedState((destinationFrame.getExtendedState() & JFrame.MAXIMIZED_BOTH) == JFrame.MAXIMIZED_BOTH ? JFrame.NORMAL : JFrame.MAXIMIZED_BOTH);
			else
